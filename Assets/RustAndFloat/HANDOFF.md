...
- **広大な白砂ビーチと透明な楽園の海**: 標高6.0m〜8.5m、島を一周する幅約50mの鮮やかな白砂ビーチテラス。
  - **漂着サバイバル情報ボックス（Drift Boxes）**:
    ...
    - **多層発光システム（遠・中・近の視認性向上）**:
      - **遠景**: アンテナ上空へ全高約70m（原点y+35m）の黄金ライトビーコン（光の柱）＆高速垂直光粒子ビームが立ち上り、島全体の遠方砂浜や上空滑空中からでも一目で発見可能。開封時に滑らかにフェードアウトして消滅。
      - **中景**: アンテナ直近にPoint Lightを配置し、未開封時は呼吸するように周囲の砂浜とチェストをあたたかく照らす（開封後はエメラルドグリーン点灯）。ランプ球体も直径0.20m＋カメラ向きソフトグロービルボードを付与。
